...
##---------------------------------- Curiosity-----------------------------------------
    ...
    opcion=int(input("[1] ==> Fotos tomadas por la Sonda Curiosity en un mes determinado\n[2] ==> Fotos tomadas por la Sonda Opportunity en un mes deternimado\n[3] ==> Asteroides cercanos a la tierra en un rango de 5 dias\n\n"))
...
""")
        ...
        year=str(annio)
        #print("el valor de year dentro del main es: ", year)
...
##----------------------------------Opportunity -----------------------------------------
        ...
        print("""La base de datos de Opportunity muestra informacion en un rengo de fechas entre2004-01-26 hasta 2018-06-07\n
\n1 => Enero\n2 => Febrero\n3 => Marzo\n4 => Abril\n5 => Mayo\n6 => Junio\n7 =>Julio\n8 => Agosto\n9 => Setiembre\n10 => Octubre\n11 => Noviembre\n12 => Diciembre 
""")
        month=int(input("Por favor escoja un mes del anio de acuerdo al numero de mes:  "))
        annio=int(input("Por favor escoga un anio en formato xxxx:  "))
